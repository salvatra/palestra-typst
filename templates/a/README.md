# Template A · Universidade do Minho
...
As funções do modelo são locais: não é preciso descarregar pacotes para compilar estes relatórios. Noto Sans e Noto Sans Mono acompanham o ZIP, com a licença OFL. A capa e o interior estão em `recursos/modelos/a.typ`; as funcionalidades partilhadas estão em `recursos/relatorio.typ`.
